...
export const micepadIntern: WorkRole = {
  role: "Intern",
  date: "2018",
  summary: "Collaborated with the CTO and global teams to develop iOS features for an international user base, implementing clean Objective-C code, Core Data persistence, and RESTful API integrations.",
  achievements: [
...
export const envirohubIntern: WorkRole = {
  role: "Intern",
  date: "2015",
  summary: "Supported the IT Manager in maintaining high-availability systems and robust security by streamlining SAP administration, resolving critical network issues, and managing firewalls to ensure zero data breaches.",
  achievements: [
