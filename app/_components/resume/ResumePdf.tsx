      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.mainPanel}>
          ...
          <ResumeMainPanelSection title="Profile">
            <Text>
              Versatile Lead Software Engineer and AWS/Terraform certified
              specialist in scalable cloud infrastructure and full-stack
              development. Expert in automating DevOps workflows and leveraging
              AI integration to solve high-impact business challenges through
          ...
          <ResumeSidePanelSection title="Certification">
            {certifications.map((certification) => (
              <View
                ...
                style={styles.sidePanelItemContainer}
              >
                <Text style={styles.sidePanelItemHeader}>
                  {certification.name}
                </Text>
                <Text style={styles.sidePanelItemMutedText}>
